...
public final class KaramScoreboardDefinition {
    ...
    private KaramScoreboardDefinition(File file, String id, boolean enabled, int priority, String permission,
                                      List<String> worlds, List<String> regions, int titleAnimationIntervalTicks,
                                      List<String> titleFrames, List<String> lines) {
        this.file = file;
        this.id = id;
    ...
    public static KaramScoreboardDefinition load(File file) {
        ...
        return new KaramScoreboardDefinition(file, id, enabled, priority, permission, worlds, regions, titleInterval, titleFrames, lines);
    }
